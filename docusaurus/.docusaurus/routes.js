...
export default [
  ...
  {
    path: '/specs/',
    component: ComponentCreator('/specs/', '139'),
    routes: [
      {
        path: '/specs/',
        component: ComponentCreator('/specs/', 'c49'),
        routes: [
          {
            path: '/specs/',
            component: ComponentCreator('/specs/', 'bff'),
            routes: [
              {
              ...
              {
                path: '/specs/ssf/ssf-002/specifications/ssf-002',
                component: ComponentCreator('/specs/ssf/ssf-002/specifications/ssf-002', '12b'),
                exact: true,
                sidebar: "fpsfSidebar"
              }
            ]
